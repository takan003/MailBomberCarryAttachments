# Mail Bomber Carry Attachments 郵件轟炸機
# Download 下載使用
...
# How to use 使用說明
## English Version
1. Please copy the "MailBomberCarryAttachments"(English version) spreadsheet to your Google Drive by "Make a copy".  
...
## 中文版本
1. 請以建立副本的方式，將「郵件轟炸機」（中文版）試算表複製到自己的雲端硬碟中。  
